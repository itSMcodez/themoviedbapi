...
import com.itsmcodez.themoviedbapi.model.core.AccountStates;
import com.itsmcodez.themoviedbapi.model.core.ReviewResultsPage;
import com.itsmcodez.themoviedbapi.model.core.TvKeywords;
import com.itsmcodez.themoviedbapi.model.core.TvSeriesResultsPage;
import com.itsmcodez.themoviedbapi.model.core.responses.ResponseStatus;
import com.itsmcodez.themoviedbapi.model.core.video.VideoResults;
import com.itsmcodez.themoviedbapi.model.core.watchproviders.ProviderResults;
import com.itsmcodez.themoviedbapi.model.tv.core.ChangeResults;
import com.itsmcodez.themoviedbapi.model.tv.core.credits.AggregateCredits;
import com.itsmcodez.themoviedbapi.model.tv.core.credits.Credits;
import com.itsmcodez.themoviedbapi.model.tv.series.AlternativeTitleResults;
import com.itsmcodez.themoviedbapi.model.tv.series.ContentRatingResults;
import com.itsmcodez.themoviedbapi.model.tv.series.EpisodeGroupResults;
import com.itsmcodez.themoviedbapi.model.tv.series.ExternalIds;
import com.itsmcodez.themoviedbapi.model.tv.series.Images;
import com.itsmcodez.themoviedbapi.model.tv.series.ScreenedTheatricallyResults;
import com.itsmcodez.themoviedbapi.model.tv.series.Translations;
import com.itsmcodez.themoviedbapi.model.tv.series.TvSeriesDb;
import com.itsmcodez.themoviedbapi.model.tv.series.TvSeriesListResultsPage;
import com.itsmcodez.themoviedbapi.tools.ApiUrl;
import com.itsmcodez.themoviedbapi.tools.RequestType;
import com.itsmcodez.themoviedbapi.tools.TmdbApiClient;
import com.itsmcodez.themoviedbapi.tools.TmdbException;
import com.itsmcodez.themoviedbapi.tools.appendtoresponse.TvSeriesAppendToResponse;
...
public class TmdbTvSeries {
     ...
     */
    TmdbTvSeries(TmdbApiClient tmdbApiClient) {
    ...
    public TvSeriesDb getDetails(int seriesId, String language, TvSeriesAppendToResponse... appendToResponse) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, TvSeriesDb.class);
    }
    ...
    public AggregateCredits getAggregateCredits(int seriesId, String language) throws TmdbException {
        ApiUrl apiUrl = new ApiUrl(TMDB_METHOD_TV, seriesId, "aggregate_credits")
            .addLanguage(language);
        return tmdbApiClient.get(apiUrl, AggregateCredits.class);
    }
    ...
    public AlternativeTitleResults getAlternativeTitles(int seriesId) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, AlternativeTitleResults.class);
    }
    ...
    public ContentRatingResults getContentRatings(int seriesId) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, ContentRatingResults.class);
    }
    ...
    public EpisodeGroupResults getEpisodeGroups(int seriesId) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, EpisodeGroupResults.class);
    }
    ...
    public TvKeywords getKeywords(int seriesId) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, TvKeywords.class);
    }
    ...
    public TvSeriesListResultsPage getLists(int seriesId, String language, Integer page) throws TmdbException {
        ApiUrl apiUrl = new ApiUrl(TMDB_METHOD_TV, seriesId, "lists")
            .addLanguage(language)
            .addPage(page);
        return tmdbApiClient.get(apiUrl, TvSeriesListResultsPage.class);
    }
    ...
    public ScreenedTheatricallyResults getScreenedTheatrically(int seriesId) throws TmdbException {
        ...
        return tmdbApiClient.get(apiUrl, ScreenedTheatricallyResults.class);
    }
