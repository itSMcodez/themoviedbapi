...
import com.itsmcodez.themoviedbapi.model.tv.core.Translations;
...
import com.itsmcodez.themoviedbapi.model.tv.season.AccountStateResults;
import com.itsmcodez.themoviedbapi.model.tv.season.ChangeResults;
import com.itsmcodez.themoviedbapi.model.tv.season.ExternalIds;
import com.itsmcodez.themoviedbapi.model.tv.season.Images;
import com.itsmcodez.themoviedbapi.model.tv.season.TvSeasonDb;
...
import com.itsmcodez.themoviedbapi.tools.appendtoresponse.TvSeasonsAppendToResponse;

import static com.itsmcodez.themoviedbapi.TmdbTvSeries.TMDB_METHOD_TV;
...
public class TmdbTvSeasons {
     ...
     */
    TmdbTvSeasons(TmdbApiClient tmdbApiClient) {
    ...
    public TvSeasonDb getDetails(int seriesId, int seasonNumber, String language, TvSeasonsAppendToResponse... appendToResponse)
        ...
        return tmdbApiClient.get(apiUrl, TvSeasonDb.class);
    }
    ...
    public AccountStateResults getAccountStates(int seriesId, int seasonNumber, String sessionId, String guestSessionId)
        ...
        return tmdbApiClient.get(apiUrl, AccountStateResults.class);
    }
